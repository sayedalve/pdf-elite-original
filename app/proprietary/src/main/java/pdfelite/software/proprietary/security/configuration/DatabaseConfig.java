...
@EnableJpaRepositories(
        basePackages = {
            "pdfelite.software.proprietary.security.database.repository",
            "pdfelite.software.proprietary.security.repository",
            "pdfelite.software.proprietary.repository",
            "pdfelite.software.proprietary.storage.repository",
            "pdfelite.software.proprietary.workflow.repository",
            "pdfelite.software.proprietary.policy.store",
            "pdfelite.software.proprietary.policy.source",
            "pdfelite.software.proprietary.policy.migration",
            "pdfelite.software.proprietary.policy.ledger",
            "pdfelite.software.proprietary.accountlink",
            "pdfelite.software.proprietary.access.repository",
            "pdfelite.software.proprietary.integration.repository"
        })
@EntityScan({
    "pdfelite.software.proprietary.security.model",
    "pdfelite.software.proprietary.model",
    "pdfelite.software.proprietary.storage.model",
    "pdfelite.software.proprietary.workflow.model",
    "pdfelite.software.proprietary.policy.store",
    "pdfelite.software.proprietary.policy.source",
    "pdfelite.software.proprietary.policy.migration",
    "pdfelite.software.proprietary.policy.ledger",
    "pdfelite.software.proprietary.accountlink",
    "pdfelite.software.proprietary.access.model",
    "pdfelite.software.proprietary.integration.model"
})
public class DatabaseConfig {
    ...
    public DatabaseConfig(
        ...
        DATASOURCE_DEFAULT_URL =
                "jdbc:h2:file:"
                        ...
                        + "pdfelite-pdf-DB-2.3.232;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE;MODE=PostgreSQL";
    ...
    private DataSource useDefaultDataSource(DataSourceBuilder<?> dataSourceBuilder) {
        ...
        String overrideUrl = System.getProperty("pdfelite.datasource.url");
        String url =
