...
import pdfelite.software.saas.controller.SaasTeamController.InviteUserRequest;
import pdfelite.software.saas.controller.SaasTeamController.RenameTeamRequest;
import pdfelite.software.saas.controller.SaasTeamController.UpdateSeatsRequest;
...
class SaasTeamControllerTest {
    ...
    private static void addRole(User user, String roleId) {
        ...
        new pdfelite.software.proprietary.security.model.Authority(roleId, user);
    }
