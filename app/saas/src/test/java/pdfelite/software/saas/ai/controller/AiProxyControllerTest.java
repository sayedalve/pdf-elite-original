...
import pdfelite.software.saas.ai.service.AiProxyService;
...
class AiProxyControllerTest {
    ...
    class OutputPathDerivation {
        ...
        void output_honoursContextPath() throws Exception {
            HttpServletRequest req = mock(HttpServletRequest.class);
            when(req.getContextPath()).thenReturn("/pdfelite");
            when(req.getRequestURI()).thenReturn("/pdfelite/api/v1/ai/output/nested/file.pdf");
