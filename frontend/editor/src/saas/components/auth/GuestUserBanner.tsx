...
export function GuestUserBanner({ className = "" }: GuestUserBannerProps) {
  ...
  useEffect(() => {
    ...
    window.addEventListener("PDFElite:show-guest-banner", show);
    return () => window.removeEventListener("PDFElite:show-guest-banner", show);
  }, []);
      ...
      <div className="guest-banner-content">
        <div className="guest-banner-text">
          <div className="guest-banner-title">
            {t("guestBanner.title", "You're using PDF Elite as a guest!")}
          </div>
