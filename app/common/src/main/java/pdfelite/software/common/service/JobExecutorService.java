...
public class JobExecutorService {
    ...
    public ResponseEntity<?> runJobGeneric(
        ...
        if (shouldQueue) {
            ...
            Supplier<Object> wrappedWork =
                    () -> {
                        try {
                            pdfelite.software.common.util.JobContext.setJobId(
                                    capturedJobIdForQueue);
                            pdfelite.software.common.util.JobContext.setOwner(jobOwner);
                            ...
                            pdfelite.software.common.util.JobContext.clear();
                        }
                    };
            ...
            executor.execute(
                    () -> {
                        try {
                            ...
                            pdfelite.software.common.util.JobContext.setJobId(capturedJobId);
                            pdfelite.software.common.util.JobContext.setOwner(jobOwner);
            ...
            try {
                ...
                pdfelite.software.common.util.JobContext.setJobId(jobId);
                Object result = executeWithTimeout(() -> work.get(), timeoutToUse);
                ...
                if (e instanceof IllegalArgumentException
                        || cause
                                instanceof
                                pdfelite.software.common.util.ExceptionUtils.BaseAppException
                        || cause
                                instanceof
                                pdfelite.software.common.util.ExceptionUtils
    ...
    private <T> T executeWithTimeout(Supplier<T> supplier, long timeoutMs)
        ...
        String currentJobId = pdfelite.software.common.util.JobContext.getJobId();

        java.util.concurrent.CompletableFuture<T> future =
                java.util.concurrent.CompletableFuture.supplyAsync(
                        () -> {
                            if (currentJobId != null) {
                                pdfelite.software.common.util.JobContext.setJobId(currentJobId);
                            }
                            try {
                                return supplier.get();
                            } finally {
