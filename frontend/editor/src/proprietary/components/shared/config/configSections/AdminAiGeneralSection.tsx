      ...
      <Stack gap="lg" className="settings-section-content">
        <div>
          ...
          <Text size="sm" c="dimmed">
            {t(
              ...
              "Connect PDFElite to the Python AI engine and choose which AI capabilities are exposed. Changes apply on restart.",
            )}
          </Text>
        </div>
          ...
          <Stack gap="md">
            ...
            <TextInput
              ...
              description={t(
                ...
                "Internal URL of the Python AI engine, e.g. http://pdf-elite-engine:5001.",
              )}
              value={settings.url || ""}
              onChange={(e) =>
                setSettings({ ...settings, url: e.target.value })
              }
              placeholder="http://pdf-elite-engine:5001"
              disabled={!enabled}
            />
        ...
        >
          <Text size="xs">
            ...
            <Code>PDFElite_ENGINE_SHARED_SECRET</Code>{" "}
            {t(
