 ...
 * to the pdfelite endpoint over the loopback via {@link InternalApiClient}, and stores the result.
 */
@Slf4j
@Component
                ...
                if (!fileStorage.fileExists(fileId)) {
                    return McpResponses.error(
                            ...
                            "Unknown or inaccessible fileId '"
                                    + fileId
                                    + "'. Re-upload with pdfelite_upload.");
                }
            ...
            if (base64 == null) {
                return McpResponses.error(
                        ...
                        "This operation needs an input file. Pass 'file' as base64 (recommended for"
                                + " most files), or 'fileId' from pdfelite_upload for large files.");
            }
        ...
        try {
            ...
            return McpResponses.result(
                    ...
                    McpResponses.textBlock(
                            mapper,
                            summary
                                    + "Large result - fetch it with pdfelite_download {\"fileId\":\""
                                    + fileId
