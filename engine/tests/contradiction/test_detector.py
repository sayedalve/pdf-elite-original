...
from pdf_elite.agents.contradiction.detector import (
...
from pdf_elite.agents.shared.chunked_mapper import ChunkOutput
from pdf_elite.contracts import AiFile
from pdf_elite.contracts.contradiction import ContradictionSeverity
from pdf_elite.contracts.documents import Page, PageRange
from pdf_elite.models import FileId, PrincipalId
...
async def test_empty_chunk_with_substantial_content_logs_warning(
    ...
    with caplog.at_level(logging.WARNING, logger="pdf_elite.agents.contradiction.detector"):
