/**
 * The PDFElite operation library.
 *
...
export const PIPELINE_OPS: Record<OpKind, PipelineOp[]> = {
  ...
  secure: [
    ...
    },
    {
      ...
      kind: "secure",
      defaultOn: true,
      desc: "AES-256 on stored artifacts. PDFElite-managed, customer KMS, or BYOK",
    },
    {
      id: "retention",
      ...
      defaultOn: true,
      pipelineOnly: true,
      desc: "How long PDFElite retains the artifact, run record, and audit trail",
    },
    {
      id: "residency",
...
export const LIBRARY_OPS: readonly LibraryOp[] = [
  ...
  },
  {
    ...
    kind: "secure",
    category: "Document Security",
    desc: "AES-256 encryption on stored artifacts (PDFElite-managed, BYOK, or HYOK)",
  },
  {
    id: "flatten-secure",
    label: "Flatten + lock",
...
export const SOURCE_OPTIONS: readonly SourceOption[] = [
  {
    ...
    label: "Upload API",
    icon: "upload",
    desc: "POST documents to a PDFElite endpoint",
  },
  {
    id: "webhook",
...
export const DESTINATION_OPTIONS: readonly DestinationOption[] = [
  {
    id: "vault",
    label: "PDFElite vault",
    icon: "shield",
    desc: "Store the processed document and extracted data in PDFElite",
  },
  {
    id: "s3",
    label: "S3 bucket",
