package pdfelite.software.saas.util;
...
class LogRedactionUtilsTest {
    ...
    class RedactEmail {
        ...
        void normalEmail_masked() {
            assertThat(LogRedactionUtils.redactEmail("john@pdfelite.com"))
                    .isEqualTo("j***@pdfelite.com");
        }
        ...
        void atSignAtStart_unchanged() {
            assertThat(LogRedactionUtils.redactEmail("@pdfelite.com")).isEqualTo("@pdfelite.com");
        }
