package pdfelite.software.saas.procurement.config;
 ...
 * Prefix {@code pdfelite.keygen}. All secrets come from the environment (relaxed binding: {@code
 * pdfelite_KEYGEN_ACCOUNT_ID}, {@code pdfelite_KEYGEN_API_TOKEN}, …) — never committed.
 *
...
@Component
@Profile("saas")
@ConfigurationProperties(prefix = "pdfelite.keygen")
public class KeygenConfigurationProperties {
    ...
    /** Keygen account id (UUID or slug). From {@code pdfelite_KEYGEN_ACCOUNT_ID}. */
    private String accountId;

    /** Keygen admin API token. From {@code pdfelite_KEYGEN_API_TOKEN}. Never log this. */
