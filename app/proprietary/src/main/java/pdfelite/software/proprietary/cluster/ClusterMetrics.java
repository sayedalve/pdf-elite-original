...
public class ClusterMetrics implements StickyMissRecorder {
    ...
    public ClusterMetrics(MeterRegistry registry, ApplicationProperties applicationProperties) {
        ...
        this.stickyMissTotal =
                Counter.builder("pdfelite_cluster_sticky_miss_total")
                        .description(
        ...
        this.rateLimitRejected =
                Counter.builder("pdfelite_cluster_ratelimit_rejected_total")
                        .description("Cluster-wide rate limit rejections")
                        .register(registry);
        this.backplaneLatency =
                Timer.builder("pdfelite_cluster_backplane_latency_seconds")
                        .description("Backplane round-trip latency")
                        .register(registry);
        this.jobWaitSeconds =
                Timer.builder("pdfelite_cluster_job_wait_seconds")
                        .description("Time jobs spend queued before execution")
                        .register(registry);
        Gauge.builder("pdfelite_cluster_jobs_inflight", jobsInflight, AtomicLong::doubleValue)
    ...
    private AtomicLong ensureLaneGauge(String lane) {
        return queueDepth.computeIfAbsent(
                ...
                l -> {
                    ...
                    Gauge.builder("pdfelite_cluster_queue_depth", holder, AtomicLong::doubleValue)
