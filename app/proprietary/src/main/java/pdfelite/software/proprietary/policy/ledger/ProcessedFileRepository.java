package pdfelite.software.proprietary.policy.ledger;
...
public interface ProcessedFileRepository
    ...
    @Query(
            "update ProcessedFileEntity e set e.status ="
                    + " pdfelite.software.proprietary.policy.ledger.ProcessedFileStatus.PROCESSING,"
    ...
    @Query(
            "update ProcessedFileEntity e set e.status ="
                    ...
                    + " where e.policyId = :policyId and e.identityHash = :identityHash"
                    + " and e.status ="
                    + " pdfelite.software.proprietary.policy.ledger.ProcessedFileStatus.INTERRUPTED"
    ...
    @Query(
            "delete from ProcessedFileEntity e where e.policyId = :policyId"
                    ...
                    + " and e.status ="
                    + " pdfelite.software.proprietary.policy.ledger.ProcessedFileStatus.DONE")
    int deleteDoneAt(
            @Param("policyId") String policyId,
            @Param("identityHash") String identityHash,
            @Param("gate") String gate);
