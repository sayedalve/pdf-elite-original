...
import pdfelite.software.common.model.ApplicationProperties.Premium.ProFeatures;
import pdfelite.software.common.model.ApplicationProperties.Premium.ProFeatures.CustomMetadata;
import pdfelite.software.common.model.PdfMetadata;

class PdfMetadataServiceTest {

    private static final String LABEL = "pdfelite-PDF v1.0.0";
    ...
    class SetMetadataNonProTests {
        ...
        void setsCreationDateWhenMissing() throws Exception {
            ...
            try (PDDocument doc = new PDDocument()) {
                ...
                // Non-pro path writes the pdfelite label as the creator.
