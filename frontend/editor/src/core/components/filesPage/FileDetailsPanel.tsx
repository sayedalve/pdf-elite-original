...
interface FileDetailsPanelProps {
  ...
  fileMap: Map<FileId, PDFEliteFileStub>;
  ...
  onSaveToServer?: (files: PDFEliteFileStub[]) => void;
...
export function FileDetailsPanel({
  ...
  const files = useMemo(
    () =>
      selectedFileIds
        ...
        .filter((f): f is PDFEliteFileStub => Boolean(f)),
  ...
  const [versionChain, setVersionChain] = useState<PDFEliteFileStub[]>([]);
  ...
  // PDFElitePDFClassification key never reveals the feature in a build without it.
  useEffect(() => {
      ...
      <div className="files-page-details-body">
        {single ? (
          <>
            ...
            {/* Version journey. Each tool run writes a new PDFEliteFile
