...
from pdf_elite.agents.pdf_review import (
    _LOCALISER_SYSTEM_PROMPT,
    PdfReviewAgent,
    _LocalisedComment,
    _LocalisedVerdict,
)
from pdf_elite.contracts import AiFile, EditPlanResponse, OrchestratorRequest, SupportedCapability
from pdf_elite.contracts.ledger import Discrepancy, DiscrepancyKind, Severity, Verdict
from pdf_elite.models import FileId, ToolEndpoint
from pdf_elite.models.agent_tool_models import AgentToolId, PdfCommentAgentParams
...
async def test_orchestrate_resume_uses_verdict_without_calling_classifier(
    ...
    from pdf_elite.contracts import MathAuditorToolReportArtifact
