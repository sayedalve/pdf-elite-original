package pdfelite.software.proprietary.security.config;
...
public class EnterpriseEndpointAspect {
    ...
    @Around(
            "@annotation(pdfelite.software.proprietary.security.config.EnterpriseEndpoint) || @within(pdfelite.software.proprietary.security.config.EnterpriseEndpoint)")
