...
import PDFEliteMark from "@app/assets/brand/modern-logo/logo512.png";
    ...
    () => [
      {
        ...
        titleFallback: "Download PDFElite for Desktop",
        descriptionKey: "onboarding.checklist.downloadDesktop.description",
        descriptionFallback: "Run PDFElite natively on your machine",
      ...
      },
      {
        ...
        descriptionFallback: "See how PDFElite works in a quick walkthrough",
      ...
      },
      {
        ...
        descriptionFallback: "Help improve PDFElite",
        ...
        >
          <span className={styles.titleGroup}>
            ...
            <span className={styles.title}>
              {t("onboarding.checklist.title", "Set up PDF Elite")}
            </span>
          </span>
