 ...
 *
 * <p>Binds the {@code pdfelite.billing.account-link.*} keys. {@link #enabled} mirrors the same flag
...
@Setter
@Component
@ConfigurationProperties(prefix = "pdfelite.billing.account-link")
public class AccountLinkProperties {
     ...
     */
    private String saasBaseUrl = "https://pdfelite.com/app";
