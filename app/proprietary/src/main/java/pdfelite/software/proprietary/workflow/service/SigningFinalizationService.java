...
import pdfelite.software.common.service.PdfSigningService;
import pdfelite.software.common.service.ServerCertificateServiceInterface;
import pdfelite.software.proprietary.workflow.dto.CertificateSubmission;
            ...
            try {
                ...
                try {
                    ClassPathResource logoRes =
                            new ClassPathResource("static/images/pdfelite-logo-white.png");
                    ...
                    log.debug(
                            "Could not load pdfelite-PDF logo for summary page: {}",
                            e.getMessage());
                    cs.setNonStrokingColor(Color.WHITE);
                    cs.beginText();
                    cs.setFont(fontBold, 13);
                    cs.newLineAtOffset(logoX, PAGE_H - 28);
                    cs.showText("pdfelite PDF");
                    cs.endText();
                }
                ...
                String footerText = "Generated by pdfelite-PDF";
