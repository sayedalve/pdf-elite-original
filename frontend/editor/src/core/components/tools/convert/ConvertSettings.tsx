...
interface ConvertSettingsProps extends ToolAutomationSettingsProps<ConvertParameters> {
...
const ConvertSettings = ({
  ...
  const onParameterChange = <K extends keyof ConvertParameters>(
    key: K,
  ...
  const updateFileSelection = (files: PDFEliteFile[]) => {
