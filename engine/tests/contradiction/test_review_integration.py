...
from pdf_elite.agents.pdf_review import PdfReviewAgent
from pdf_elite.contracts import (
    AiFile,
    Contradiction,
    ContradictionReport,
...
from pdf_elite.contracts.contradiction import Claim
from pdf_elite.documents import DocumentService, SqliteVecStore
from pdf_elite.models import FileId, OwnerId, PrincipalId, ToolEndpoint, UserId
from pdf_elite.models.tool_models import AddCommentsParams
from pdf_elite.services import current_user_id
from pdf_elite.services.runtime import AppRuntime
...
def test_which_claim_rejects_non_literal_values() -> None:
    ...
    from pdf_elite.agents.pdf_review import _PairedLocalisedContradiction
...
async def test_contradiction_intent_emits_add_comments_plan(
    ...
    from pdf_elite.agents.pdf_review import _LocalisedContradictionReport, _PairedLocalisedContradiction
...
async def test_contradiction_takes_precedence_over_math(
    ...
    from pdf_elite.agents.pdf_review import _LocalisedContradictionReport
