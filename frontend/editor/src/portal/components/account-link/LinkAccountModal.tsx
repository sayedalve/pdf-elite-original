...
/**
 * In-app account-link login. Signs the admin in to their PDFElite (SaaS) account
      ...
      subtitle={
        reauth
          ? t(
              ...
              "Your session expired — sign back in to your PDFElite account. Your instance stays linked.",
            )
          : t(
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          ...
          >
            ...
            {t(
              ...
              "to enable in-app linking against the hosted PDFElite account.",
            )}
          </Banner>
          {import.meta.env.DEV && (
            <Button
