...
public class SaasDataSourceConfig {
    ...
    @Value("${spring.datasource.hikari.data-source-properties.ApplicationName:pdfelitePDF-SaaS}")
    private String applicationName;

    // search_path so native SQL hits pdfelite_pdf, not the postgres-default public.
    @Value(
            "${spring.datasource.hikari.connection-init-sql:SET search_path TO pdfelite_pdf, auth, public}")
