...
export const Radio_Group: Story = {
  render: () => {
    function Bound() {
      const [mode, setMode] = useState<"PDFElite" | "byok" | "hyok">(
        "PDFElite",
      );
      return (
        <FormField label="Key mode">
          <RadioGroup
            ...
            options={[
              {
                value: "PDFElite",
                label: "PDFElite-managed",
                description: "PDFElite generates and rotates keys.",
              },
              {
                value: "byok",
                label: "BYOK (AWS KMS)",
              ...
              },
              {
                ...
                description: "PDFElite never sees the key material.",
              },
            ]}
          />
        </FormField>
        ...
        <Stack gap="4">
          ...
          <FormField label="Key mode">
            <RadioGroup
              ...
              onChange={setMode}
              options={[
                { value: "PDFElite", label: "PDFElite-managed" },
