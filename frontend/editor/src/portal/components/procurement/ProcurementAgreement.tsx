...
/**
 * The agreement (security) step: a single combined PDFElite Enterprise Agreement — Master Service
  ...
  return (
    <Card padding="loose">
      ...
      <div className="portal-agreement__doc">
        ...
        <p>
          This PDFElite Enterprise Agreement ("Agreement") is entered into
          between PDF Elite Inc. ("PDFElite") and the customer identified on the
          Order Form ("Customer"). It governs Customer's access to and use of
          the PDFElite enterprise platform and related services (the "Service").
          PDFElite will provide the Service with commercially reasonable skill
          and care and in accordance with the service levels set out in the
          Order Form.
        </p>
        ...
        <p>
          Subject to the terms of this Agreement, PDFElite grants Customer a
          ...
          Service, and all intellectual property in it, remains PDFElite's.
        </p>

        <h4>5. Data Processing Agreement</h4>
        <p>
          Where PDFElite processes personal data on Customer's behalf, it does
          ...
          transfers, and security commitments are as described in PDFElite's
        ...
        <p>
          ...
          On acceptance, PDFElite will issue the committed annual subscription
