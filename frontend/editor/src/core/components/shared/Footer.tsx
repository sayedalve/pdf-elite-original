...
export default function Footer({
  ...
  // Default URLs
  const defaultTermsUrl = "https://www.PDFElite.com/terms";
  const defaultPrivacyUrl = "https://www.PDFElite.com/privacy";
    ...
    >
      ...
      >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          href="https://github.com/PDFElite-Tools/pdf-elite"
        >
