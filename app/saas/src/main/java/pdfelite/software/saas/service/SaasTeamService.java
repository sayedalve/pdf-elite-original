package pdfelite.software.saas.service;
...
import pdfelite.software.common.model.enumeration.InvitationStatus;
...
import pdfelite.software.saas.accountlink.LinkedInstanceRepository;
import pdfelite.software.saas.billing.repository.BillingSubscriptionRepository;
import pdfelite.software.saas.config.SupabaseConfigurationProperties;
import pdfelite.software.saas.model.TeamInvitation;
import pdfelite.software.saas.repository.SaasTeamExtensionsRepository;
...
public class SaasTeamService {
    ...
    private final pdfelite.software.proprietary.security.service.UserService userService;
    ...
    public void acceptInvitationAndGrantRole(String invitationToken, User acceptingUser)
            throws java.sql.SQLException,
                    pdfelite.software.common.model.exception.UnsupportedProviderException {
        ...
        userService.changeRole(
                user, pdfelite.software.common.model.enumeration.Role.PRO_USER.getRoleId());
    }
