...
/**
 * Configures the shared Supabase client against the PDFElite Supabase project so
 ...
 * — the one PDFElite Supabase project every flavor talks to (same vars the editor
...
export const PENDING_LINK_KEY = "PDFElite-account-link-pending";
