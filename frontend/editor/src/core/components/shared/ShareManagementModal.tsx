  ...
  const createShareLink = useCallback(async () => {
    ...
    try {
      ...
      if (token) {
        ...
        actions.updatePDFEliteFileStub(file.id, { remoteHasShareLinks: true });
  ...
  const handleRevokeLink = useCallback(
    async (token: string) => {
      ...
      try {
        ...
        actions.updatePDFEliteFileStub(file.id, {
                    ...
                    <Stack gap="xs">
                      <Text size="sm">
                        {t(
                          ...
                          "This looks like an email address. If this person is not already a PDF Elite user, they will not be able to access the file.",
                        )}
                      </Text>
                      <Group justify="flex-end" gap="sm">
                        <Button
