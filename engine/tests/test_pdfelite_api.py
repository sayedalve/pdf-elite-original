...
from pdf_elite.api.dependencies import (
...
from pdf_elite.config import load_settings
...
from pdf_elite.models.tool_models import Angle, RotatePdfParams
from pdf_elite.services import emit_progress
...
def test_orchestrator_route_emits_heartbeats_while_agent_is_busy() -> None:
    ...
    try:
        with patch("pdf_elite.api.routes.orchestrator.HEARTBEAT_INTERVAL_SECONDS", 0.03):
            with client.stream(
                "POST",
                "/api/v1/orchestrator",
