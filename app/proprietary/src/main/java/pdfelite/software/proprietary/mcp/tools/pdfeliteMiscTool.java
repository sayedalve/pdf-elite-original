...
public class pdfeliteMiscTool extends AbstractCategoryTool {

    public pdfeliteMiscTool(
            ObjectMapper mapper,
    ...
    @Override
    public String name() {
        return "pdfelite_misc";
    }

    @Override
    public String description() {
        return "Miscellaneous PDF operations: compress, OCR, stamp / watermark, edit metadata,"
                + " flatten, repair, and similar utilities. Call pdfelite_describe_operation with"
