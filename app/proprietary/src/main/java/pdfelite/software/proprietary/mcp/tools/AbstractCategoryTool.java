...
abstract class AbstractCategoryTool implements McpTool {
    ...
    public ObjectNode inputSchema() {
        ...
        opDesc.append(
                "Operation id from this category. Call pdfelite_describe_operation first to learn"
        ...
        params.put(
                "description",
                "Per-operation parameters. Schema available via pdfelite_describe_operation.");
        ...
        McpToolSupport.stringProperty(
                props,
                "fileId",
                "Reference to a file already stored via pdfelite_upload. Recommended only for large"
