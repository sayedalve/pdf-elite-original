...
interface ScannerImageSplitSettingsProps extends ToolAutomationSettingsProps<ScannerImageSplitParameters> {}
...
const ScannerImageSplitSettings: React.FC<ScannerImageSplitSettingsProps> = ({
  ...
  const onParameterChange = <K extends keyof ScannerImageSplitParameters>(
    key: K,
