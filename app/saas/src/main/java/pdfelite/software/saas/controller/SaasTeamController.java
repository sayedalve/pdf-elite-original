package pdfelite.software.saas.controller;
...
import pdfelite.software.saas.model.TeamInvitation;
import pdfelite.software.saas.repository.TeamInvitationRepository;
import pdfelite.software.saas.security.TeamSecurityExpressions;
import pdfelite.software.saas.service.SaasTeamExtensionService;
...
public class SaasTeamController {
    ...
    public ResponseEntity<?> rejectInvitation(@PathVariable String token) {
        try {
            ...
            if (invitation.getStatus()
                    != pdfelite.software.common.model.enumeration.InvitationStatus.PENDING) {
                throw new IllegalStateException("Can only reject pending invitations");
            }

            invitation.setStatus(
                    pdfelite.software.common.model.enumeration.InvitationStatus.REJECTED);
    ...
    public ResponseEntity<?> cancelInvitation(@PathVariable Long invitationId) {
        try {
            ...
            invitation.setStatus(
                    pdfelite.software.common.model.enumeration.InvitationStatus.CANCELLED);
            invitationRepository.save(invitation);
                            ...
                            .map(
                                    m ->
                                            toTeamDetailsDTO(
                                                    m.getTeam(),
                                                    m.getRole()
                                                            == pdfelite.software.common.model
    ...
    public ResponseEntity<?> removeTeamMember(
        ...
        try {
            ...
            if (pdfelite.software.common.model.enumeration.Role.PRO_USER
                    .getRoleId()
                    .equals(currentRole)) {
                log.info(
                ...
                userService.changeRole(
                        userToRemove,
                        pdfelite.software.common.model.enumeration.Role.USER.getRoleId());
            }
            ...
            boolean isLeader =
                    membershipRepository
                            ...
                            .map(
                                    m ->
                                            m.getRole()
                                                    == pdfelite.software.common.model.enumeration
                                                            .TeamRole.LEADER)
                            .orElse(false);
