...
import {
  useAnnotationStyleState as useAnnotationStyleStateHook,
  AnnotationStyleStateReturn,
} from "@app/tools/annotate/useAnnotationStyleState";
...
interface AnnotationContextValue {
  ...
  styleStateReturn: AnnotationStyleStateReturn;
}
...
export const AnnotationProvider: React.FC<{ children: ReactNode }> = ({
  ...
  const styleStateReturn = useAnnotationStyleStateHook();
