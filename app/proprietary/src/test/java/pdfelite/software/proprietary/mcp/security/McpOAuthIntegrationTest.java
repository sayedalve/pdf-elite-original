...
import pdfelite.software.proprietary.mcp.McpServerController;
...
class McpOAuthIntegrationTest {
    ...
    void validToken_callsToolsListSuccessfully() throws Exception {
        ...
        assertThat(response.body()).contains("pdfelite_describe_operation");
    }
    ...
    @Test
    void validTokenButNopdfeliteAccount_isRejectedWith403() throws Exception {
    ...
    static class TestApp {
        ...
        UserService userService() {
            ...
            pdfelite.software.proprietary.security.model.User account =
                    org.mockito.Mockito.mock(
                            pdfelite.software.proprietary.security.model.User.class);
