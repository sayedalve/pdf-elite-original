...
export function SecurityTab() {
  ...
  const ACCESS_OPTS: RadioOption<AccessPolicy>[] = [
    {
      value: "PDFElite",
      label: t("portal.infrastructure.security.access.PDFElite.label"),
      description: t(
        "portal.infrastructure.security.access.PDFElite.description",
      ),
    },
    {
      value: "byok",
  ...
  const accessValue = access ?? data?.accessPolicy ?? "PDFElite";
      ...
      <section>
        ...
        <Card padding="loose" className="portal-infra__keymgmt">
          <div className="portal-infra__keymgmt-head">
            ...
            {/* Rotation is a privileged backend action; disabled where PDFElite
