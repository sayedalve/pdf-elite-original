          ...
          <Stack gap="md">
            ...
            <div>
              <TextInput
                ...
                description={t(
                  ...
                  "Base directory for temporary files (leave empty for default: java.io.tmpdir/pdf-elite)",
                )}
                ...
                placeholder={t(
                  ...
                  "Default: java.io.tmpdir/pdf-elite",
                )}
                disabled={!loginEnabled}
              />
            </div>
            ...
            <div>
              <TextInput
                ...
                value={settings.tempFileManagement?.prefix || "pdf-elite-"}
                onChange={(e) =>
                  setSettings({
                    ...settings,
                    tempFileManagement: {
