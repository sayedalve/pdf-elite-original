package pdfelite.software.proprietary.workflow.service;
...
import pdfelite.software.proprietary.storage.model.FilePurpose;
import pdfelite.software.proprietary.storage.model.ShareAccessRole;
import pdfelite.software.proprietary.storage.model.StoredFile;
import pdfelite.software.proprietary.storage.provider.StorageProvider;
import pdfelite.software.proprietary.storage.provider.StoredObject;
import pdfelite.software.proprietary.storage.repository.StoredFileRepository;
import pdfelite.software.proprietary.workflow.dto.ParticipantRequest;
import pdfelite.software.proprietary.workflow.dto.WetSignatureMetadata;
import pdfelite.software.proprietary.workflow.dto.WorkflowCreationRequest;
import pdfelite.software.proprietary.workflow.model.ParticipantStatus;
import pdfelite.software.proprietary.workflow.model.WorkflowParticipant;
import pdfelite.software.proprietary.workflow.model.WorkflowSession;
import pdfelite.software.proprietary.workflow.model.WorkflowStatus;
import pdfelite.software.proprietary.workflow.repository.WorkflowParticipantRepository;
import pdfelite.software.proprietary.workflow.repository.WorkflowSessionRepository;
...
public class WorkflowSessionService {
     ...
     */
    @Transactional(readOnly = true)
    public List<pdfelite.software.proprietary.workflow.dto.SignRequestSummaryDTO> listSignRequests(
            User user) {
        ...
        return participations.stream()
                .map(
                        p -> {
                            ...
                            pdfelite.software.proprietary.workflow.dto.SignRequestSummaryDTO dto =
                                    new pdfelite.software.proprietary.workflow.dto
     ...
     */
    @Transactional(readOnly = true)
    public pdfelite.software.proprietary.workflow.dto.SignRequestDetailDTO getSignRequestDetail(
            String sessionId, User user) {
        WorkflowSession session = getSession(sessionId);
        WorkflowParticipant participant = getParticipantForUser(session, user);

        pdfelite.software.proprietary.workflow.dto.SignRequestDetailDTO dto =
                new pdfelite.software.proprietary.workflow.dto.SignRequestDetailDTO();
        dto.setSessionId(session.getSessionId());
        dto.setDocumentName(session.getDocumentName());
        dto.setOwnerUsername(session.getOwner().getUsername());
    ...
    public void signDocument(
            String sessionId,
            User user,
            pdfelite.software.proprietary.workflow.dto.SignDocumentRequest request) {
        WorkflowSession session = getSession(sessionId);
        WorkflowParticipant participant = getParticipantForUser(session, user);
