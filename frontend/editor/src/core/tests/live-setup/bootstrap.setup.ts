 ...
 *      `admin / PDFElite` user (created with firstLogin=true), exercise
...
const DEFAULT_BACKEND_PASSWORD = "PDFElite";
...
test.describe("Live-suite bootstrap", () => {
  test("first-login: change default admin/PDFElite to admin/adminadmin", async ({
    page,
    request,
  }) => {
