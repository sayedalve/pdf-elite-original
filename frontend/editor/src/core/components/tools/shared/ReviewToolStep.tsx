  ...
  const handleDownload = async () => {
    ...
    try {
      await saveOperationResults({
        ...
        getStub: (fileId) => selectors.getPDFEliteFileStub(fileId as FileId),
        markSaved: (fileId, savedPath) => {
          const stub = selectors.getPDFEliteFileStub(fileId as FileId);
          fileActions.updatePDFEliteFileStub(fileId as FileId, {
