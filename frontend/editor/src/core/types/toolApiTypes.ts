...
export interface SignPDFWithCertRequest {
  ...
  password?: string;
  /**
   * Absolute path to the PKCS#11 driver library (required for PKCS11 type). Must be an allowed driver - a detected one or configured via PDFElite_PKCS11_LIBRARIES.
   */
