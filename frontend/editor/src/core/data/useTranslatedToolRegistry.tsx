...
import { replaceImageOperationConfig } from "@app/hooks/tools/replaceImage/useReplaceImageOperation";
  ...
  return useMemo(() => {
    const allTools: ToolRegistry = {
      ...
      merge: {
        ...
        // Merge is a multi-file tool: route selection to the fileEditor
        // workbench, where the file grid drives selection/reordering and the
        // tool host (ToolRenderer) renders Merge's sort/settings/execute flow.
        ...
        automationSettings: lazySettings(
          lazy(() => import("@app/components/tools/merge/MergeSettings")),
        ),
      ...
      sign: {
        ...
        automationSettings: lazySettings(
          lazy(() => import("@app/components/tools/sign/SignSettings")),
      ...
      sanitize: {
        ...
        automationSettings: lazySettings(
          lazy(() => import("@app/components/tools/sanitize/SanitizeSettings")),
        ),
      ...
      flatten: {
        ...
        automationSettings: lazySettings(
          lazy(() => import("@app/components/tools/flatten/FlattenSettings")),
        ),
      ...
      replaceImage: {
        icon: (
          <LocalIcon
            icon="replace-outline-rounded"
            width="1.5rem"
            height="1.5rem"
          />
        ),
        name: t("home.replaceImage.title", "Replace Image"),
        component: lazy(() => import("@app/tools/ReplaceImage")),
        description: t("home.replaceImage.desc", "Replace images in your PDF"),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.GENERAL,
        maxFiles: 1,
        endpoints: ["replace-image"],
        operationConfig: asRegistryConfig(replaceImageOperationConfig),
        synonyms: getSynonyms(t, "replaceImage"),
        automationSettings: null,
      },
      removePassword: {
        icon: (
      ...
      devFolderScanning: {
        ...
        categoryId: ToolCategoryId.ADVANCED_TOOLS,
        subcategoryId: SubcategoryId.DEVELOPER_TOOLS,
        link: "https://docs.PDFElitepdf.com/Configuration/Folder%20Scanning/",
      ...
      devSsoGuide: {
        ...
        categoryId: ToolCategoryId.ADVANCED_TOOLS,
        subcategoryId: SubcategoryId.DEVELOPER_TOOLS,
        link: "https://docs.PDFElitepdf.com/Configuration/Single%20Sign-On%20Configuration/",
      ...
      devAirgapped: {
        ...
        categoryId: ToolCategoryId.ADVANCED_TOOLS,
        subcategoryId: SubcategoryId.DEVELOPER_TOOLS,
        link: "https://docs.PDFElitepdf.com/Paid-Offerings/#activating-your-license",
      ...
      compress: {
        ...
        automationSettings: lazySettings(
          lazy(() => import("@app/components/tools/compress/CompressSettings")),
        ),
      ...
      convert: {
        ...
        automationSettings: lazySettings(
          lazy(() => import("@app/components/tools/convert/ConvertSettings")),
        ),
      ...
      ocr: {
        ...
        description: t(
          "home.ocr.desc",
          "Convert scanned PDFs into searchable and selectable text",
        ),
        categoryId: ToolCategoryId.RECOMMENDED_TOOLS,
        subcategoryId: SubcategoryId.GENERAL,
        maxFiles: 1,
