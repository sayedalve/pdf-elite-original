...
This guide explains how to set up Windows code signing for PDF Elite desktop application builds.
...
Get-AuthenticodeSignature "./src-tauri/target/release/bundle/msi/PDF Elite_*.msi"
```
...
**Windows (PowerShell):**
```powershell
Get-AuthenticodeSignature "PDF Elite-windows-x86_64.exe"
Get-AuthenticodeSignature "PDF Elite-windows-x86_64.msi"
```
