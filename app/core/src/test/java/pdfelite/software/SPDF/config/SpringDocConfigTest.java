...
class SpringDocConfigTest {
    ...
    class PdfProcessingApi {
        ...
        void infoCustomizerSetsTitle() {
            ...
            assertThat(openApi.getInfo().getTitle()).isEqualTo("pdfelite PDF - Processing API");
    ...
    class AdminApi {
        ...
        void infoCustomizerSetsTitle() {
            ...
            assertThat(openApi.getInfo().getTitle()).isEqualTo("pdfelite PDF - Management API");
    ...
    class SystemApi {
        ...
        void infoCustomizerSetsTitle() {
            ...
            assertThat(openApi.getInfo().getTitle()).isEqualTo("pdfelite PDF - System API");
            assertThat(openApi.getInfo().getDescription()).isNotBlank();
        }
    }
}
