package pdfelite.software.common.annotations;
...
/**
 * Shortcut for a POST endpoint that is executed through the pdfelite "auto‑job" framework.
 *
 * <p>Behaviour notes:
 *
 * <ul>
 ...
 *       pdfelite.software.common.service.JobExecutorService JobExecutorService} where it may be
 ...
 *       pdfelite.software.common.service.TaskManager TaskManager} and can be polled via <code>
...
public @interface AutoJobPostMapping {
     ...
     * pdfelite.software.common.enumeration.ResourceWeight} for the standard tiers.
     *
