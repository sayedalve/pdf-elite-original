 ...
 *
 * <p>Gated behind {@code pdfelite.billing.account-link.enabled}: off → beans absent → 404.
 */
@Slf4j
@Hidden
@RestController
...
@Profile("saas")
@ConditionalOnProperty(name = "pdfelite.billing.account-link.enabled", havingValue = "true")
