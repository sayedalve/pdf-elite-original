...
import pdfelite.software.common.model.ApplicationProperties.Driver;
...
class ApplicationPropertiesLogicTest {
    ...
    void tempFileManagement_defaults_and_overrides() {
        ...
        String expectedBase =
                Path.of(java.lang.System.getProperty("java.io.tmpdir"), "pdfelite-pdf").toString();
    ...
    void enterprise_metadata_defaults() {
        ...
        assertEquals("pdfelite-PDF", eMeta.getCreator());
        assertEquals("pdfelite-PDF", eMeta.getProducer());
    }
    ...
    void premium_metadata_defaults() {
        ...
        pMeta.setCreator("");
        pMeta.setProducer("");
        assertEquals("pdfelite-PDF", pMeta.getCreator());
        assertEquals("pdfelite-PDF", pMeta.getProducer());
    }
