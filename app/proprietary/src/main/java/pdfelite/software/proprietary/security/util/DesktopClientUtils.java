package pdfelite.software.proprietary.security.util;
...
public class DesktopClientUtils {
    ...
    public static boolean isDesktopClient(HttpServletRequest request) {
        ...
        boolean haspdfelite = userAgentLower.contains("pdfelitepdf-desktop");
        boolean hasElectron = userAgentLower.contains("electron");
        boolean isDesktop = hasTauri || haspdfelite || hasElectron;
