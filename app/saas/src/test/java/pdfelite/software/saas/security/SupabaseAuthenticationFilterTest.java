...
class SupabaseAuthenticationFilterTest {
    ...
    @Mock private pdfelite.software.saas.service.SaasTeamService saasTeamService;
    @Mock private JwtDecoder jwtDecoder;

    @Mock
    private pdfelite.software.proprietary.security.service.ApiKeyAuthenticationService
    ...
    void apiKeyHeaderPopulatesSecurityContext() throws Exception {
        ...
        when(apiKeyAuthenticationService.authenticate("api-key-123"))
                .thenReturn(
                        Optional.of(
                                new pdfelite.software.proprietary.security.service
