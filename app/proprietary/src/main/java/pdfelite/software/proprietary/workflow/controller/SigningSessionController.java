package pdfelite.software.proprietary.workflow.controller;
...
import pdfelite.software.proprietary.workflow.dto.CertificateInfo;
import pdfelite.software.proprietary.workflow.dto.CertificateValidationResponse;
...
import pdfelite.software.proprietary.workflow.service.CertificateSubmissionValidator;
import pdfelite.software.proprietary.workflow.service.SigningFinalizationService;
import pdfelite.software.proprietary.workflow.service.WorkflowSessionService;
...
public class SigningSessionController {
    ...
    public ResponseEntity<?> listSessions(Principal principal) {
        ...
        try {
            ...
            List<pdfelite.software.proprietary.workflow.model.WorkflowSession> sessions =
                    workflowSessionService.listUserSessions(user);
            List<pdfelite.software.proprietary.workflow.dto.WorkflowSessionResponse> responses =
                    sessions.stream()
                            .map(
                                    pdfelite.software.proprietary.workflow.util.WorkflowMapper
                                            ::toResponse)
                            .toList();
    ...
    public ResponseEntity<?> createSession(
        ...
        try {
            ...
            return ResponseEntity.ok(
                    pdfelite.software.proprietary.workflow.util.WorkflowMapper.toResponse(session));
        } catch (Exception e) {
    ...
    public ResponseEntity<?> getSession(
        ...
        try {
            ...
            return ResponseEntity.ok(
                    pdfelite.software.proprietary.workflow.util.WorkflowMapper.toResponse(
    ...
    public ResponseEntity<?> signDocument(
            @PathVariable("sessionId") @NotBlank String sessionId,
            @ModelAttribute pdfelite.software.proprietary.workflow.dto.SignDocumentRequest request,
            Principal principal) {
        workflowSessionService.ensureSigningEnabled();
        if (principal == null) {
            return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body("Authentication required");
