...
const BANNER_DISMISSED_KEY = "PDFElitepdf_features_banner_dismissed";
      ...
      {!hideAdminBanner && loginDisabled && !bannerDismissed && (
        ...
        >
          ...
          <Stack gap="sm">
            ...
            <Anchor
              href="https://docs.PDFElitepdf.com/Configuration/System%20and%20Security/"
              target="_blank"
              size="sm"
              style={{ color: "var(--mantine-color-blue-6)" }}
            >
                ...
                <Text size="xs" c="dimmed">
                  {desktopUpdateMode.locked
                    ? t(
                        ...
                        "Your administrator has configured how pdf-elite handles updates on this machine. Contact them to change this.",
                      )
                    : t(
        ...
        <UpdateModal
          ...
          onRemindLater={() => {
            localStorage.setItem(
              "pdf-elite-updater:snoozedUntil",
