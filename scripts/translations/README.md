...
This directory contains Python scripts for managing frontend translations in PDF Elite. These tools help analyze, merge, validate, and manage translations against the en-US golden truth file.

## Current Format: TOML

**PDF Elite uses TOML format for translations** in `frontend/editor/public/locales/{lang}/translation.toml`.
...
- Uses GPT-5.6 with specialized prompts for PDF Elite
...
- Specialized system prompts for PDF Elite translations
