...
export const LOCAL_MODE_STORAGE_KEY = "PDFElite-local-mode";
export const JWT_EXPIRED_PROMPTED_KEY = "PDFElite-jwt-expired-prompted";
  ...
  private async loadConfig(): Promise<void> {
    try {
      ...
      if (localFlag === "true") {
        ...
        // MSI installs with PDFElite_SERVER_URL are excluded because they have a
