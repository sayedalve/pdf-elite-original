package pdfelite.software.proprietary.audit;
...
public final class AuditContext {
    ...
    public static final String REQ_ATTR_POLICY_NAME = "pdfelite.audit.policyName";

    /** Request attribute: the ordered tool endpoint paths a run executes. */
    public static final String REQ_ATTR_POLICY_STEPS = "pdfelite.audit.policySteps";
