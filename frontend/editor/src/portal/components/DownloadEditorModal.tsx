...
const WINGET = "winget install PDFEliteTools.PDFElitePDF";
const BREW = "brew install --cask pdf-elite";
const dockerCmd = (tag: string) =>
  `docker run -d --name pdf-elite -p 8080:8080 \\\n  -v ./PDFElite-data:/configs \\\n  PDFElitetools/pdf-elite:${tag}`;
const HELM = `helm repo add pdf-elite https://PDFElite-tools.github.io/pdf-elite/
helm repo update
helm install pdf-elite pdf-elite/pdf-elite-chart \\\n  --namespace pdf-elite --create-namespace`;
const JAR_URL = "https://files.PDFElitepdf.com/pdf-elite-with-login.jar";
const JAR =
  "java -Xmx2g -jar pdf-elite-with-login.jar\n# then open http://localhost:8080";

const GUIDES = {
  windows: "https://docs.PDFElitepdf.com/Installation/Windows%20Installation/",
  mac: "https://docs.PDFElitepdf.com/Installation/Mac%20Installation/",
  linux: DOWNLOAD_URLS.LINUX_DOCS,
  docker: "https://docs.PDFElitepdf.com/Installation/Docker%20Install",
  kubernetes: "https://docs.PDFElitepdf.com/Installation/Kubernetes",
