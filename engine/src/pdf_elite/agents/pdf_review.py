...
from pdf_elite.agents.contradiction import ContradictionDetector, ContradictionIntentClassifier
from pdf_elite.agents.contradiction.detector import _escape_for_tag
from pdf_elite.agents.contradiction.prompts import REVIEW_LOCALISER_PROMPT
from pdf_elite.agents.math_presentation import MathIntentClassifier, extract_math_verdict
...
from pdf_elite.contracts.ledger import Discrepancy
from pdf_elite.models import ApiModel, PrincipalId, ToolEndpoint
from pdf_elite.models.agent_tool_models import (
    AgentToolId,
    MathAuditorAgentParams,
    PdfCommentAgentParams,
)
from pdf_elite.models.tool_models import AddCommentsParams
from pdf_elite.services import AppRuntime, require_current_user_id
