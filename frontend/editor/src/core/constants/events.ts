...
export const SERVER_LICENSE_REQUEST_EVENT = "PDFElite:server-license-requested";
export const UPGRADE_BANNER_TEST_EVENT = "PDFElite:upgrade-banner-test";
export const UPGRADE_BANNER_ALERT_EVENT = "PDFElite:upgrade-banner-alert";
export const START_TOUR_EVENT = "PDFElite:start-tour";
export const TOUR_STATE_EVENT = "PDFElite:tour-state";
