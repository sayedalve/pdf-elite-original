...
const FileSidebar = forwardRef<HTMLDivElement, FileSidebarProps>(
  function FileSidebar(
    ...
    const [allFileStubs, setAllFileStubs] = useState<PDFEliteFileStub[]>([]);
    ...
    const [deleteTarget, setDeleteTarget] = useState<PDFEliteFileStub | null>(
      null,
    );
    ...
    const handleConfirmSidebarDelete = useCallback(
      async (scope: DeleteScope) => {
        ...
        if (scope === "device" || scope === "everywhere") {
          ...
          fileActions.updatePDFEliteFileStub(stub.id, cleared);
    ...
    const renderFileRow = (stub: PDFEliteFileStub) => {
      ...
      >
        ...
        <div className="file-sidebar-inner">
          ...
          <NavSurface className="file-sidebar-controls">
            ...
            {/* Google Drive removed — PDF Elite is an offline desktop application */}
