...
function deltaToolFor(
  version: PDFEliteFileStub,
  prior: PDFEliteFileStub | null,
): ToolOperation | null {
...
export function VersionTimeline({
  ...
  const byVersionNumber = useMemo(() => {
    const map = new Map<number, PDFEliteFileStub>();
  ...
  type Row =
    | { kind: "version"; version: PDFEliteFileStub }
    | {
        kind: "ellipsis";
        hidden: number;
      };
