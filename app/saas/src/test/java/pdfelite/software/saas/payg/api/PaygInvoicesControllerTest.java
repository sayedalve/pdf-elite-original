...
import pdfelite.software.saas.payg.api.PaygInvoicesController.InvoiceResponse;
...
import pdfelite.software.saas.payg.stripe.StripeInvoiceDao;
...
class PaygInvoicesControllerTest {
    ...
    void list_mapsRowsAndClampsLimit() {
        ...
        try (var mocked = org.mockito.Mockito.mockStatic(AuthenticationUtils.class)) {
            ...
            assertThat(body.description()).isEqualTo("pdfelite Processor Plan");
