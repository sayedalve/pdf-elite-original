...
public class InstallationPathConfig {
    ...
    private static String initializeBasePath() {
        ...
        // -Dpdfelite.base-path=... or pdfelite_BASE_PATH=... so a Playwright
        // run never touches a developer's working state.
        String override = System.getProperty("pdfelite.base-path");
        if (override == null || override.isBlank()) {
            override = System.getenv("pdfelite_BASE_PATH");
        }
        if (override != null && !override.isBlank()) {
