...
public class DescribeOperationTool implements McpTool {
    ...
    @Override
    public String name() {
        return "pdfelite_describe_operation";
    }

    @Override
    public String description() {
        return "Return the full JSON Schema for one pdfelite operation's parameters. Call this "
                ...
                + "category tool (pdfelite_convert, _pages, _misc, _security, _ai).";
    }
