...
from pdf_elite.agents import OrchestratorAgent
from pdf_elite.contracts import AiFile, OrchestratorRequest
from pdf_elite.contracts.pdf_edit import EditPlanResponse
from pdf_elite.models import FileId
...
async def test_delegate_pdf_review_wires_prompt_to_tool_step(runtime: AppRuntime) -> None:
    ...
    with patch(
        "pdf_elite.agents.pdf_review.MathIntentClassifier.classify",
