...
import pdfelite.software.common.model.ApplicationProperties.Html.UrlSecurity;
...
class SsrfProtectionServiceTest {
    ...
    class MediumNetworkBlocking {
        ...
        void blocksUnresolvableHost() {
            assertThat(service.isUrlAllowed("http://nonexistent-host-pdfelite-test.invalid/page"))
                    .isFalse();
        }
    }
