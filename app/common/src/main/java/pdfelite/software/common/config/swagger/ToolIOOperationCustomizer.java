package pdfelite.software.common.config.swagger;
...
/**
 * Publishes each {@link ToolIO} into the spec as {@code x-pdfelite-io}, which is how the frontend
...
public class ToolIOOperationCustomizer
    ...
    public static final String EXTENSION_NAME = "x-pdfelite-io";
    public static final String VOCABULARY_EXTENSION_NAME = "x-pdfelite-io-vocabulary";
