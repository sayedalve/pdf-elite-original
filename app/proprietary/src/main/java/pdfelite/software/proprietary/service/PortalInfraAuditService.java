...
import pdfelite.software.proprietary.audit.PortalAuditEventRow;
import pdfelite.software.proprietary.model.api.audit.InfraAuditEventDto;
import pdfelite.software.proprietary.model.api.audit.InfraAuditLogResponse;
import pdfelite.software.proprietary.model.api.audit.InfraAuditSummary;
...
public class PortalInfraAuditService {
    ...
    private InfraAuditEventDto toDto(PortalAuditEventRow event) {
        ...
        // via the X-pdfelite-Policy-Name header to make a direct call pose as a policy row.
     ...
     * X-pdfelite-Policy-Name header on a direct tool call can't overwrite its true action.
     */
