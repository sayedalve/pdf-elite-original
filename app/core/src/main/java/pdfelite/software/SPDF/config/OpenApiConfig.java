...
public class OpenApiConfig {
    ...
    private static final String DEFAULT_TITLE = "pdfelite PDF API";
                ...
                new Info()
                        ...
                        .license(
                                new License()
                                        ...
                                        .url(
                                                "https://raw.githubusercontent.com/pdfelite-Tools/pdfelite-PDF/refs/heads/main/LICENSE"))
                        .termsOfService("https://www.pdfelitepdf.com/terms")
                        .contact(
                                new Contact()
                                        .name("pdfelite Software")
                                        .url("https://www.pdfelitepdf.com")
                                        .email("contact@pdfelitepdf.com"))
