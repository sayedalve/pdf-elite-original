...
import pdfelite.software.saas.accountlink.DeviceCredentialAuthenticationFilter;
...
public class SupabaseSecurityConfig {
    ...
    SecurityFilterChain saasSecurityFilterChain(
        ...
        // The filter bean exists only when pdfelite.billing.account-link.enabled=true; when off it
        ...
        List<String> configuredOrigins =
                operatorOverride
                        ...
                        : List.of(
                                ...
                                "http://localhost:8080",
                                "https://pdfelite.com",
                                "https://app.pdfelite.com",
                                "https://api.pdfelite.com");
