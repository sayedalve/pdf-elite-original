package pdfelite.software.proprietary.policy.input;
...
import pdfelite.software.proprietary.policy.config.FolderAccessGuard;
...
class FolderInputSourceTest {
    ...
    void consumeRemovesTheFileOnceProcessed() throws IOException {
        ...
        assertTrue(Files.notExists(inputDir.resolve(".pdfelite")));
    ...
    void hiddenFilesAndTheLegacyWorkDirAreIgnored() throws IOException {
        ...
        Path legacy = Files.createDirectories(inputDir.resolve(".pdfelite").resolve("done"));
    ...
    void recursiveDiscoversSubdirectoriesButNotHiddenOnes() throws IOException {
        ...
        Path hiddenDir = Files.createDirectories(inputDir.resolve(".pdfelite"));
        Files.writeString(hiddenDir.resolve("skipped.pdf"), "c");
        // Sink staging inside a watched subdirectory is pruned at any depth.
        Path nestedStaging = Files.createDirectories(sub.resolve(".pdfelite").resolve("tmp"));
