...
interface ReplaceColorSettingsProps extends ToolAutomationSettingsProps<ReplaceColorParameters> {}
...
const ReplaceColorSettings = ({
  ...
  const onParameterChange = <K extends keyof ReplaceColorParameters>(
    key: K,
