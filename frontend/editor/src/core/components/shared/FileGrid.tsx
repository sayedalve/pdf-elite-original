...
interface FileGridProps {
  files: Array<{ file: File; record?: PDFEliteFileStub }>;
  onRemove?: (index: number) => void;
  onDoubleClick?: (item: { file: File; record?: PDFEliteFileStub }) => void;
  onView?: (item: { file: File; record?: PDFEliteFileStub }) => void;
  onEdit?: (item: { file: File; record?: PDFEliteFileStub }) => void;
      ...
      >
        {displayFiles
          .filter((item) => {
            if (!item.record?.id) {
              console.error(
                "FileGrid: File missing PDFEliteFileStub with proper ID:",
                item.file.name,
              );
              return false;
            }
