...
export class UpdateService {
  private readonly baseUrl =
    "https://supabase.PDFElite.com/functions/v1/updates";
  ...
  async getCurrentVersionFromGitHub(): Promise<string> {
    const url =
      "https://raw.githubusercontent.com/PDFElite-Tools/pdf-elite/V2-master/build.gradle";
