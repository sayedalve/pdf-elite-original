...
public class WebhookReceiverController {
    ...
    static final String SIGNATURE_HEADER = "X-pdfelite-Signature";
    static final String FILENAME_HEADER = "X-pdfelite-Filename";
    ...
    @Operation(
            ...
            description =
                    "The body is the raw document; sign it with the source's secret and present"
                            + " 'sha256=<hex>' in the X-pdfelite-Signature header. Returns 202 once"
