package pdfelite.software.saas.procurement.api;
...
import pdfelite.software.saas.procurement.pricing.QuoteLineItem;
import pdfelite.software.saas.procurement.service.ProcurementService;
                        ...
                        cert ->
                                ResponseEntity.ok()
                                        .header(
                                                ...
                                                "attachment; filename=\"pdfelite-enterprise.lic\"")
