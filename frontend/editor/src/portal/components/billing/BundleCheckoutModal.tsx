...
export function BundleCheckoutModal({
  ...
  async function downloadPdf() {
    ...
    try {
      ...
      a.href = url;
      a.download = `${ensured.stripeQuote.stripeQuoteNumber ?? "PDFElite-quote"}.pdf`;
...
function CalculatorStep({
  ...
  const deployCards: PickerCard[] = [
    {
      id: "cloud",
      title: t("portal.billing.prepaid.deploy.cloud", "PDFElite Cloud"),
      desc: t(
        "portal.billing.prepaid.deploy.cloudDesc",
        "Managed by PDFElite. Live in minutes.",
      ),
    },
    {
      id: "selfhost",
