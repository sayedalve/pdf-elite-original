...
import { StickyNoteHoverLayer } from "@app/components/viewer/StickyNoteHoverLayer";
        ...
        initialDocuments: [
          {
            url: pdfUrl,
            name: exportFileName,
            scale: 96 / 72, // Convert PDF points (72 DPI) to physical pixels (96 DPI) so 100% is accurate
          },
        ],
      }),
          ...
          onInitialized={async (registry: PluginRegistry) => {
            ...
            if (enableAnnotations) {
              ...
              ensureTool({
                ...
                // Click-to-place: a single click on the page drops a default-sized
                // text box and opens it for typing (mirrors the "note" tool). This
                // makes the Edit-mode "Add Text" action work as "click a position →
                // type" rather than requiring a precise drag to size the box first.
                clickBehavior: {
                  enabled: true,
              ...
              ensureTool({
                ...
                matchScore: (annotation: PdfAnnotationObject) =>
                  annotation.type === PdfAnnotationSubtype.TEXT ? 8 : 0,
                defaults: {
                ...
                clickBehavior: {
                  enabled: true,
                  defaultSize: { width: 32, height: 32 }, // Sticky note icon size
                },
                behavior: {
                  deactivateToolAfterCreate: true,
                  selectAfterCreate: true,
