...
// The trademarked PDFElite wordmark — the font is baked into the SVG (no brand webfont is loaded), so
// we render the same asset the portal nav uses rather than styled text. Theme-switched in CSS.
import wordmarkLight from "@app/assets/brand/modern-logo/PDFEliteProcessorLogoBlackText.svg";
import wordmarkDark from "@app/assets/brand/modern-logo/PDFEliteProcessorLogoWhiteText.svg";

/**
 * Shared header for the prepay-flow modals — the prepaid wizard (activation → calculator → pay, of 3)
 * and the metered checkout (spend limit → payment, of 2): PDFElite brand + "Step N of M" badge + close,
