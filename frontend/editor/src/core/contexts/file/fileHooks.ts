 ...
 */
export function useCurrentFile(): { file?: File; record?: PDFEliteFileStub } {
...
export function useFileManagement() {
  ...
  return useMemo(
    () => ({
      ...
      updatePDFEliteFileStub: actions.updatePDFEliteFileStub,
 ...
 */
export function usePDFEliteFileStub(fileId: FileId): {
  file?: File;
  record?: PDFEliteFileStub;
} {
  const { state, selectors } = useFileState();
  ...
  return useMemo(
    () => ({
      ...
      record: selectors.getPDFEliteFileStub(fileId),
    }),
...
export function useAllFiles(): {
  ...
  return useMemo(
    () => ({
      ...
      fileStubs: selectors.getPDFEliteFileStubs(),
...
export function useSelectedFiles(): {
  ...
  selectedFileStubs: PDFEliteFileStub[];
  ...
  return useMemo(
    () => ({
      ...
      selectedFileStubs: selectors.getSelectedPDFEliteFileStubs(),
      selectedFileIds: state.ui.selectedFileIds,
    }),
    [state.ui.selectedFileIds, state.files.byId, selectors],
  );
