...
const PROMPT_DISMISSED_KEY = "PDFElitepdf_default_app_prompt_dismissed";
...
export const defaultAppService = {
  /**
   * Check if PDF Elite is the default PDF handler
   */
  ...
  /**
   * Set or prompt to set PDF Elite as default PDF handler
