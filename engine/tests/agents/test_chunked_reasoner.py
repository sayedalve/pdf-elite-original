...
from pdf_elite.agents.shared.chunked_mapper import _ChunkExtraction
from pdf_elite.agents.shared.chunked_reasoner import ChunkedReasoner, ChunkNotes
from pdf_elite.contracts import WholeDocSliceDone
from pdf_elite.contracts.documents import Page
from pdf_elite.services import reset_progress_emitter, set_progress_emitter
...
class TestReason:
    ...
    async def test_runs_one_chunk_per_slice_and_synthesises(self, runtime: AppRuntime) -> None:
        ...
        from pdf_elite.agents.shared.chunked_reasoner import _ExtractedNotes
...
class TestPromptConstruction:
    def test_extraction_prompt_includes_question_and_page_markers(self, runtime: AppRuntime) -> None:
        ...
        from pdf_elite.agents.shared.chunked_mapper import ChunkedMapper
