...
from pdf_elite.agents.shared import ChunkedReasoner, ChunkNotes, WholeDocReaderCapability
from pdf_elite.contracts import AiFile, PageText
from pdf_elite.documents import Document, DocumentService, SqliteVecStore
from pdf_elite.models import FileId, OwnerId, PrincipalId
...
class StubEmbedder:
    ...
    def chunk_and_prepare(
        ...
        from pdf_elite.documents.chunker import chunk_text
