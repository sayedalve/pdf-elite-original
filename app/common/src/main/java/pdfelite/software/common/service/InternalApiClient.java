...
/**
 * Dispatches HTTP POST requests to internal pdfelite API endpoints via loopback. Used by
...
public class InternalApiClient {
     ...
     */
    public static final String AUTOMATION_HEADER = "X-pdfelite-Automation";
     ...
     * call.
     */
    public static final String POLICY_NAME_HEADER = "X-pdfelite-Policy-Name";
