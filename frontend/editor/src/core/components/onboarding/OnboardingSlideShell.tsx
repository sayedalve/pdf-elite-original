...
/**
 * Hero art for the inset panel. `appIcon` renders the PDFElite app mark
...
export function ShellHero({
  ...
  if (appIcon) {
    return (
      <img src={PDFEliteMark} alt="PDFElite" className={styles.heroAppIcon} />
    );
  }
      ...
      <div className={styles.card}>
        <header className={styles.header}>
          <div className={styles.brand}>
            ...
            />
            <span className={styles.wordmark}>PDFElite</span>
          </div>
