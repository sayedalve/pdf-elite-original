package pdfelite.software.proprietary.security.configuration.ee;

import static pdfelite.software.proprietary.security.configuration.ee.KeygenLicenseVerifier.License;
...
import pdfelite.software.common.model.ApplicationProperties.EnterpriseEdition;
import pdfelite.software.common.model.ApplicationProperties.Premium;
    ...
    public void migrateEnterpriseSettingsToPremium(ApplicationProperties applicationProperties) {
        ...
        if (enterpriseMetadata != null && premiumMetadata != null) {
            ...
            if ((premiumMetadata.getCreator() == null
                            || "pdfelite-PDF".equals(premiumMetadata.getCreator()))
                    && enterpriseMetadata.getCreator() != null
                    && !"pdfelite-PDF".equals(enterpriseMetadata.getCreator())) {
            ...
            if ((premiumMetadata.getProducer() == null
                            || "pdfelite-PDF".equals(premiumMetadata.getProducer()))
                    && enterpriseMetadata.getProducer() != null
                    && !"pdfelite-PDF".equals(enterpriseMetadata.getProducer())) {
